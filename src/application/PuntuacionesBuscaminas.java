...
public static void display() {
		...
		try {
			 ...
			 rs = stmt.executeQuery("SELECT Puntuaciones.Id_Usuario, Puntuacion, Usuarios.Nombre FROM Puntuaciones LEFT JOIN Usuarios On Puntuaciones.Id_Usuario == Usuarios.ID_Usuario where Id_juego = 1 order by Puntuacion desc LIMIT 5"); //consulta (select, udpate, delete, insert)
